...
export async function POST(request: NextRequest) {
  try {
    ...
    // Generate Mux stream URL for transcription
    const streamUrl = `https://stream.mux.com/${video.playback_id}.m3u8`

    try {
      // Start Deepgram transcription (placeholder for now)
      // TODO: Implement actual Deepgram API call when API key is available
