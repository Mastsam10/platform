-- Migration: User Profiles & Channel System (FIXED VERSION)
...
-- Step 9: Migrate existing data FIRST (before creating indexes)
...
-- Step 10: Create indexes AFTER data migration (FIXED ORDER)
